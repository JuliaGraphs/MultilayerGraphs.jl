...
"""
    outneighbors(mg::M, v::T) where {M <: AbstractMultilayerUGraph{T} } where { T <: Integer}
...
"""
function get_projected_monoplex_graph(mg::M) where  {T,U,M<:AbstractMultilayerUGraph{T,U}}
