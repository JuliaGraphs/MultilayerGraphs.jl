...
function _add_edge!(g::Graphs.SimpleGraphs.AbstractSimpleGraph{T}, src::T, dst::T; weight::W = nothing, metadata::Union{Tuple,NamedTuple} = NamedTuple()) where {T <: Integer, U<: Real, W<: Union{U, Nothing}}
