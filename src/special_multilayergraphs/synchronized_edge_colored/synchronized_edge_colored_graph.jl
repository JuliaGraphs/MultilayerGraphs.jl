"""
    SyncronizedEdgeColoredGraph{T, U, G <: AbstractGraph{T}} <: AbstractMultilayerGraph{T,U}
...
"""
mutable struct SyncronizedEdgeColoredGraph{T,U} <: AbstractSynchronizedEdgeColoredGraph{T,U}
...
# Traits
@traitimpl IsWeighted{SyncronizedEdgeColoredGraph}
@traitimpl IsMeta{SyncronizedEdgeColoredGraph}
