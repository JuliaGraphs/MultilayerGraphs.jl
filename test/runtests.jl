...
_layer_simplegraph = layer_simplegraph(:layer_simplegraph, sample(mvs_layers, _nv, replace = false), _ne)
...
_layer_simpledigraph = layer_simpledigraph(:layer_simpledigraph, sample(mvs_layers, _nv, replace = false), _ne)
...
_layer_simpleweightedgraph_default = layer_simpleweightedgraph(:layer_simpleweightedgraph_default, node_vertices ,_ne, default_edge_weight = (src,dst) -> 3.0)
...
_layer_simpleweighteddigraph = layer_simpleweighteddigraph(:layer_simpleweighteddigraph, sample(mvs_layers, _nv, replace = false), _ne, default_edge_weight = (src,dst) -> 3.0)
...
_layer_metagraph = layer_metagraph(:layer_metagraph, sample(mvs_metadata, _nv, replace = false), _ne, default_vertex_metadata = mv -> (metamv =  5,), default_edge_metadata = (src,dst) -> (metaedge = "metadata of edge from $src to $dst",))
...
_layer_metadigraph = layer_metadigraph(:layer_metadigraph, sample(mvs_metadata, _nv, replace = false), _ne, default_vertex_metadata = mv -> (metamv = "metadata of $mv",), default_edge_metadata = (src,dst) -> (metaedge = "metadata of edge from $src to $dst",))
...
_layer_valgraph = layer_valgraph(:layer_valgraph, sample(mvs_metadata, _nv, replace = false), _ne, default_vertex_metadata = mv -> ("metadata of $mv",), default_edge_metadata = (src,dst) -> (metaedge = "metadata of edge from $src to $dst",))
...
_layer_valoutdigraph = layer_valoutdigraph(:layer_valoutgraph, sample(mvs_metadata, _nv, replace = false), _ne, default_vertex_metadata = mv -> ("metadata of $mv",), default_edge_metadata = (src,dst) -> (metaedge = "metadata of edge from $src to $dst",))
...
_layer_valdigraph = layer_valdigraph(:layer_valdigraph, sample(mvs_metadata, _nv, replace = false), _ne,default_vertex_metadata = mv -> ("metadata of $mv",), default_edge_metadata = (src,dst) -> (metaedge = "metadata of edge from $src to $dst",))
...
_interlayer_simplegraph = interlayer_simplegraph(layer_sg, layer_swg, collect(edges(interlayer_sg_swg)))
...
_interlayer_simpleweightedgraph = interlayer_simpleweightedgraph(layer_swg, layer_mg, _ne, default_edge_weight = (src,dst) -> 4.0)
...
# Test simplified constructor with edge tuples
_interlayer_metagraph = interlayer_metagraph(layer_mg, layer_vg, [(src(edge), dst(edge)) for edge in edges(interlayer_mg_vg)], default_edge_metadata = (src,dst) -> ("mymeta",))
@test all(getindex.(metadata.(edges(_interlayer_metagraph)),1) .== ("mymeta",))
_interlayer_metagraph = interlayer_metagraph(layer_mg, layer_vg, _ne, default_edge_metadata = (src,dst) -> ("mymeta",))
...
_interlayer_valgraph = interlayer_valgraph(layer_sg, layer_mg, [(src(edge), dst(edge)) for edge in edges(interlayer_multiplex_sg_mg)], default_edge_metadata = (src,dst) -> ("mymeta",))
@test all(getindex.(metadata.(edges(_interlayer_valgraph)),1) .== ("mymeta",))
_nv_1 = nv(layer_sg)
_nv_2=  nv(layer_mg)
_ne = rand(1:(_nv_1 * _nv_2))
_interlayer_valgraph = interlayer_valgraph(layer_sg, layer_mg, _ne, default_edge_metadata = (src,dst) -> ("mymeta",))
...
_interlayer_simpledigraph = interlayer_simpledigraph(layer_sdg, layer_swdg, collect(edges(interlayer_sdg_swdg)))
...
_interlayer_simpleweighteddigraph = interlayer_simpleweighteddigraph(layer_swdg, layer_mdg, _ne, default_edge_weight = (src,dst) -> 4.0)
...
# Test simplified constructor with edge tuples
_interlayer_metadigraph = interlayer_metadigraph(layer_mdg, layer_vodg, [(src(edge), dst(edge)) for edge in edges(interlayer_mdg_vodg)], default_edge_metadata = (src,dst) -> ("mymeta",))
@test all(getindex.(metadata.(edges(_interlayer_metadigraph)),1) .== ("mymeta",))
_interlayer_metadigraph = interlayer_metadigraph(layer_mdg, layer_vodg, _ne, default_edge_metadata = (src,dst) -> ("mymeta",))
...
# Test simplified constructor with edge tuples
_interlayer_valoutdigraph = interlayer_valoutdigraph(layer_vodg, layer_vdg, [(src(edge), dst(edge)) for edge in edges(interlayer_vodg_vdg)], default_edge_metadata = (src,dst) -> ("mymeta",))
@test all(getindex.(metadata.(edges(_interlayer_valoutdigraph)),1) .== ("mymeta",))
_interlayer_valoutdigraph = interlayer_valoutdigraph(layer_vodg, layer_vdg, _ne, default_edge_metadata = (src,dst) -> ("mymeta",))
...
# Test simplified constructor with edge tuples
_interlayer_valdigraph = interlayer_valdigraph(layer_sdg, layer_mdg, [(src(edge), dst(edge)) for edge in edges(interlayer_sdg_mdg)], default_edge_metadata = (src,dst) -> ("mymeta",))
@test all(getindex.(metadata.(edges(_interlayer_valdigraph)),1) .== ("mymeta",))
_interlayer_valdigraph = interlayer_valdigraph(layer_sdg, layer_mdg, _ne, default_edge_metadata = (src,dst) -> ("mymeta",))
