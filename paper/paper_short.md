...
Here is a list of related packages implemented in the [R language](https://www.r-project.org): 
...
Here is a list of related packages implemented in the [Python language](https://www.python.org): 
